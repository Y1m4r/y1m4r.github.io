import styles from './HeaderBackgroundShape.module.css';

const HeaderBackgroundShape = () => (
  <div className={styles.shape}>
    <svg
        ...
        >
          <g opacity="0.8" filter="url(#filter0_f_66_5508)">
...
export default HeaderBackgroundShape;
